...
#define TGPS_CMD_I         0xC0  // KNACKSAT_II - TGPS ,****CMD      RADFET NO.1 ADDRESS
#define TGPS_CMD_II        0xC1  // KNACKSAT_II - TGPS ,****CMD      RADFET NO.2 ADDRESS
#define TGPS_CMD_III       0xC2  // KNACKSAT_II - TGPS ,****CMD      RADFET NO.3 ADDRESS
#define TGPS_CMD_IV        0xC3  // KNACKSAT_II - TGPS ,****CMD      RADFET NO.4 ADDRESS
#define TGPS_CMD_V         0xC4  // KNACKSAT_II - TGPS ,****CMD      RADFET NO.5 ADDRESS
#define TGPS_CMD_VI        0xC5  // KNACKSAT_II - TGPS ,****CMD      RADFET NO.6 ADDRESS
#define TGPS_CMD_VII       0xC6  // KNACKSAT_II - TGPS ,****CMD      RADFET NO.7 ADDRESS
#define TGPS_CMD_VIII      0xC7  // KNACKSAT_II - TGPS ,****CMD      RADFET NO.8 ADDRESS

#define TGPS_CMD_IX        0xC8  // KNACKSAT_II - TGPS ,****CMD    MICRO SD CARD ADDRESS
...
//             START & END STATE          :  1 BYTE         0
//             FILENAME                   :  1 BYTE         1
//             COUNTING CHECK             :  4 BYTES      2-5
//             ERROR CHARACTER            :  4 BYTES      6-9
//             TIME PROCESS               :  4 BYTES    10-13
//             CHARACTER TO CHECK         :  1 BYTE        14
//             FRIST CHARACTER            :  1 BYTE        15
//       >>> READ MICRO SD CRAD   (SHIELD)
//             START & END STATE          :  1 BYTE        16
//             FILENAME                   :  1 BYTE        17
//             COUNTING CHECK             :  4 BYTES    18-21
//             ERROR CHARACTER            :  4 BYTES    22-25
//             TIME PROCESS               :  4 BYTES    26-29
//             CHARACTER TO CHECK         :  1 BYTE        30
//             FRIST CHARACTER            :  1 BYTE        31
//             ================================================
//             TOTAL                        32 BYTES     0-31
//             ================================================
//
...
byte         BUS_IV             [32]         ;  // FOR REQUEST_IV
byte         BUS_V              [32]         ;  // FOR REQUEST_V
byte         BUS_VI             [32]         ;  // FOR REQUEST_VI
byte         BUS_VII            [32]         ;  // FOR REQUEST_VII
byte         BUS_VIII           [32]         ;  // FOR REQUEST_VIII
byte         BUS_IX             [32]         ;  // FOR REQUEST_IX
// ====================================================================
...
void setup()
{
  ...
  pinMode(        S0, OUTPUT)    ;  // PIN SETTING FOR SELECT CHANNEL 0 MULTIPLEX
  pinMode(        S1, OUTPUT)    ;  // PIN SETTING FOR SELECT CHANNEL 1 MULTIPLEX
  pinMode(        S2, OUTPUT)    ;  // PIN SETTING FOR SELECT CHANNEL 2 MULTIPLEX

  pinMode(          A, INPUT)    ;  // PIN SETTING FOR ANALOG CHANNEL MULTIPLEX

  digitalWrite(PIN_SD_CS1, HIGH) ;  // TURN ON CHIP SELECT 1
  digitalWrite(PIN_SD_CS2, HIGH) ;  // TURN ON CHIP SELECT 2

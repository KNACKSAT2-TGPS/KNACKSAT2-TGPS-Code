...
void loop()
{
  ...
  {    
    ...
    if (CMD_FUNCTION == "DOWNLOAD")
    {
      ...
      Serial.println("TIME PROGRESS : " + String((unsigned long)(END_TIME_PROCESS - BEGIN_TIME_PROCESS)) + " MICROSECOND");
      Serial.println("==========================================================");
      Serial.println();
    }
    ...
    if (CMD_FUNCTION == "LOOP")
    {
      ...
      Serial.println("==========================================================");
      Serial.println();
      Serial.println("PROGRESS TIME : " + String(9.5 * ROUND_PROCESS) + " MINUTE");
    ...
    if (CMD == "HELP")
    {
      ...
      Serial.println("                       EXAMPLE I2C_CONNECTED_DEVICE                                \n");
      Serial.println("=====================================================================================");
      Serial.println();
    }
  }
